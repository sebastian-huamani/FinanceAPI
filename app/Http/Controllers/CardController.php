    ...
    public function showAll()
    {
        try {
            $data = Card::where('user_id', auth()->user()->id)
                ...
                ->select('cards.id', 'cards.name', 'cards.bottom_line', 'cards.amount', 'cards.name_banck', 'type_cards.name as type_card', 'colors.color_panel_top', 'colors.color_panel_bottom', 'colors.color_type', 'colors.color_button')
                ->get();
